...
candle_patterns = [
    ...
    ('CDLBELTHOLD', '捉腰帶線'),
    ('CDLBREAKAWAY', '脫離'),
    ('CDLCLOSINGMARUBOZU', '收盤光頭光腳'),
    ('CDLCONCEALBABYSWALL', '藏嬰吞沒'),
    ('CDLCOUNTERATTACK', '反擊線'),
    ('CDLDARKCLOUDCOVER', '烏雲蓋頂'),
    ('CDLDOJI', '十字'),
    ('CDLDOJISTAR', '十字星'),
    ('CDLDRAGONFLYDOJI', '蜻蜓/T型十字'),
    ('CDLENGULFING', '吞沒形態'),
    ('CDLEVENINGDOJISTAR', '十字暮星'),
    ('CDLEVENINGSTAR', '暮星'),
    ('CDLGAPSIDESIDEWHITE', '兩側白色缺口'),
    ('CDLGRAVESTONEDOJI', '墓碑/倒T十字'),
    ('CDLHAMMER', '錘頭'),
    ('CDLHANGINGMAN', '上吊線'),
    ('CDLHARAMI', '孕線'),
    ('CDLHARAMICROSS', '十字孕線'),
    ...
    ('CDLKICKINGBYLENGTH', 'Kicking-長短判斷'),
    ('CDLLADDERBOTTOM', '梯形底部'),
    ('CDLLONGLEGGEDDOJI', '長腿十字'),
    ('CDLLONGLINE', '長蠟燭'),
    ('CDLMARUBOZU', '光頭光腳'),
    ('CDLMATCHINGLOW', '匹配低點'),
    ('CDLMATHOLD', 'Mathold 鋪墊'),
